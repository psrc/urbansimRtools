...
pph.dt <- data.table(pph.df[, c(1:8, 10:11, 13:14, 29:34)])
#fix column headers
colnames(pph.dt)[-(2:5)] <- c("control_id", "name", "hh2020_nonhct", "hh2050_nonhct", 
                              "hh2020_hct", "hh2050_hct", "hh2020_tot", "hh2050_tot",
                              "pph2020_nonhct", "pph2050_nonhct", 
